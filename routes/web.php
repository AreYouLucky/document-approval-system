...
use App\Http\Controllers\DocumentChange\ProcessOwnerController;
...
Route::get('/qmr/review-document/{id}', [QMRReviewController::class, 'ViewQMRReview']);
...
Route::middleware(['auth', 'role:Document Custodian'])->group(function () {
    ...
    Route::get('/dc/final-review-document/{id}', [DCReviewController::class, 'FinalreviewDocument']);
...
Route::middleware(['auth', 'role:Process Owner'])->group(function () {
    Route::get('/process/view-documents', function () {
        return Inertia::render('DocumentChange/ProcessOwner/Layouts/ProcessDocumentTabs');
    });
    Route::get('/process/pending-list', function () {
        return Inertia::render('DocumentChange/ProcessOwner/DocumentList/ProcessPendingList');
    });
    Route::get('/process/revision-list', function () {
        return Inertia::render('DocumentChange/ProcessOwner/DocumentList/ProcessRevisionList');
    });
    Route::get('/process/rejected-list', function () {
        return Inertia::render('DocumentChange/ProcessOwner/DocumentList/ProcessRejectedList');
    });
    Route::get('/process/approved-list', function () {
        return Inertia::render('DocumentChange/ProcessOwner/DocumentList/ProcessApprovedList');
    });
    Route::get('/process/load-pending-documents', [ProcessOwnerController::class, 'loadPendingDocuments']);
    Route::get('/process/load-revision-documents', [ProcessOwnerController::class, 'loadForRevisionDocuments']);
    Route::get('/process/load-rejected-documents', [ProcessOwnerController::class, 'loadRejectedDocuments']);
    Route::get('/process/load-approved-documents', [ProcessOwnerController::class, 'loadApprovedDocuments']);
    Route::get('/process/view-revise-documents/{id}', [ProcessOwnerController::class, 'viewReviseDocument']);
    Route::get('/process/get-revise-documents/{id}', [ProcessOwnerController::class, 'getReviseDocument']);
    Route::post('/process/submit-revise-documents', [ProcessOwnerController::class, 'submitDocumentRevision']);

    //view count of document list processes
    Route::get('/process/get-processes-count', [ProcessOwnerController::class, 'documentListCount']);
    
});

//QMR ROUTES
Route::middleware(['auth', 'role:QMR'])->group(function () {
