...
export default function MessageBar({ className = "" }) {
    ...
    return (
        <div className={`relative w-full mx-auto ` + className}>
            ...
            <button
                className="p-2 bg-blue-300 dark:bg-gray-700 rounded-lg text-gray-700 dark:text-gray-300"
            >
                <Badge
                    className="absolute -top-2 -right-2 bg-red-600 rounded-xl text-white text-xs"
                >
                    20
                </Badge>
                <LuMessageCircle />
