...
import DocumentUploadAlert from '../All/DocumentUploadAlert';
import PrimaryButton from '@/Components/Forms/PrimaryButton';
import { MdDataSaverOn } from "react-icons/md";
import SuccessDialogs from '@/Components/Toasts/SuccessDialogs';
import EmptyDocuments from '../All/EmptyDocuments';
    ...
    >
      ...
      <div className="w-full p-5">
        ...
        <div className="w-full  grid grid-cols-3 gap-4">
          <div className={`mb-4 text-gray-900 w-full  dark:text-gray-50 bg-gray-50 dark:bg-gray-800  p-8 col-span-2 rounded-lg shadow-xl`}>
          ...
          <div className={`mb-4 text-gray-900 w-full  dark:text-gray-50 bg-gray-50 dark:bg-gray-800  p-8 rounded-lg shadow-xl grid grid-cols-2`}>
        ...
        <div className='mb-4 text-gray-900 w-full  dark:text-gray-50 bg-gray-50 dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden p-4'>
          {
            data.file ?
              (
                <>
