...
import { GrDocumentTime, GrDocumentConfig, GrDocumentVerified } from "react-icons/gr";
            ...
            <div className='w-full px-4 py-4 '>
                ...
                <div className="w-full bg-white dark:bg-gray-800 rounded-lg py-5 px-10 shadow-lg  dark:border-gray-950 ">
                    <div className="w-full flex flex-row border-b">
                        ...
                        {/* <Link className={` ${base} ${url === "/process/approved-list" ? on : off} `} href='/process/approved-list'>
                            <div className="flex items-center gap-2">
                                <GrDocumentVerified />
                                <span className='nunito-regular'>Approved</span>
                                {Number(data.approved) > 0 && <Badge color="red" className="bg-blue-200 rounded-xl text-slate-800 text-xs">{data.approved}</Badge>}
                            </div>
                        </Link> */}
                    </div>
