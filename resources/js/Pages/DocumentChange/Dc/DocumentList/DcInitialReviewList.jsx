...
export default function DcInitialReviewList() {
    ...
    const fetchDocuments = () => {
        setLoading(true)
        axios.get('/dc/load-initial-review-documents').then(
            res => {
                ...
                <DataTable headers={headers}>
                    {loading ? (
                        ...
                        currentDocuments.map((item, index) => (
                            <tr key={index} className=" border-b dark:bg-gray-800 dark:border-gray-700  hover:bg-gray-200 dark:hover:bg-gray-600" >
