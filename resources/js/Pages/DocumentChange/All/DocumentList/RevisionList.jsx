                            ...
                            <tr key={index} className=" border-b dark:bg-gray-800 dark:border-gray-700  hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-900 dark:text-gray-50" >
                                ...
                                <td className="px-6 py-4 text-center">
                                    {Number(item.is_final) === 0 && Number(item.progress_status) === 1 ? (
                                        <> <Badge color="gray" icon={HiClock} className='text-center w-fit ' >
                                            For Revision (DC)
                                        </Badge></>
                                ...
                                <td className="flex justify-center items-center py-2 ">
                                    <PrimaryButton className="m-1 px-2 py-1 text-xs bg-blue-500 text-white " onClick={() => { router.visit('/process/view-revise-documents/' + item.revision_id) }}>Revise</PrimaryButton>
