...
function DcInitialReview() {
    ...
    const tabs = [
        { name: "ISO Documents", url: "/qmr/view-documents" },
        { name: "QMR Document Review", url: "" },
    ];
    ...
    const getDocumentInformation = () => {
        ...
        axios.get('/qmr/get-document-details/' + id).then(
            res => {
    ...
    const sendFormData = (formData) => {
        axios.post('/qmr/post-review-documents', formData)
            .then(res => {
                getDocumentInformation();
                setDialogOpen(false)
                setProcessing(false)
    ...
    return (
        ...
        >
            ...
            <div className="w-full p-4">
                ...
                {document.latest_revision?.progress_status === 2 ? (<>
                            ...
                            <div className='roboto-regular grid grid-cols-1 gap-1  h-fit text-sm w-full'>
                                ...
                                <div className='flex mt-3 gap-2 flex-wrap justify-center'>
                                    <button className='bg-blue-500 text-gray-50 rounded-lg px-4 py-3' onClick={() => openDialog(1)} disabled={processing}>
                                        <span className='text-sm flex items-center justify-center font-mono'> Approve
                                    ...
                                    <button className='bg-red-600 text-gray-50 rounded-lg px-4' onClick={() => openDialog(2)} disabled={processing}>
                    ...
                    <>
                        {document?.latest_revision?.progress_status !== 2 && <DoneReview></DoneReview>}
                    </>)}
