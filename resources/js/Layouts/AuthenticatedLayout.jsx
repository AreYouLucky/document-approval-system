...
import NotificationBar from '@/Components/Clickables/NotificationBar';
...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className='min-h-screen roboto-regular bg-blue-50 dark:bg-gray-900 dark:text-white  nunito-sm w-full max-w-full overflow-x-hidden'>
            <SideNav isOpen={isOpen} setIsOpen={setIsOpen} />
            <div className={`transition-all duration-300 ${isOpen ? "ml-64" : "ml-0"}`}>
                <div className="w-full flex justify-between items-center py-3 dark:bg-gray-950 bg-white shadow-md border-b">
                    <div className="flex">
                    ...
                    <div className="flex items-center ">
                        {/* <SearchBar className='min-w-[200px] hidden md:block' />
                        <div className="hidden md:flex md:items-center">
                            <NotificationBar className="ml-2" />
                        </div> */}
                        <ToggleTheme darkMode={darkMode} setDarkMode={setDarkMode} className="mr-8" />
                        <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button"
                            className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 md:hidden">
                            <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path clipRule="evenodd" fillRule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
                            </svg>
                        </button>
